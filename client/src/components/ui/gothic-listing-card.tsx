...
export default function GothicListingCard({ listing }: GothicListingCardProps) {
  return (
    <GothicCard className="min-w-80 max-w-80 h-full minimalist-card glow-chase carousel-item">
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <h3 className="text-white font-semibold text-lg line-clamp-2 text-subtle-glow transition-colors">
            {listing.title}
          </h3>
          ...
          <div className="pt-2">
            <a
              ...
              className="inline-flex items-center gap-2 text-purple-400 hover:text-purple-300 transition-colors group interactive-link"
            >
